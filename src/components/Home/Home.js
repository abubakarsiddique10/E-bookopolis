...
const Home = () => {
    ...
    const reviewCustomer = reviews.filter(review => review.id < 4);
        ...
        <div>
            <Container className="mt-5">
                <Row className="d-flex align-items-center">
                    <Col className="text-start">
                        ...
                        <Button className="home-btn px-5 mt-2">Explore More</Button>
                    </Col>
                    <Col className="ms-4">
            ...
            <Container className="my-5">
                ...
                <Row xs={1} md={2} lg={3} className="g-4">
                    {
                        reviewCustomer.map(review => <CustomerReview key={review.id} review={review}></CustomerReview>)
                    }
                </Row>
                <Button onClick={handleClick} className="mt-4 w-50">See All Reviews</Button>
            </Container>
        </div>
    )
}
